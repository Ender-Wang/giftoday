...
const tiers = [
  {
    ...
    features: [
      ...
      extracFeature: 'Get 10 % discount for every product',
    featured: false,
  },
  {
    name: 'Premium user',
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      {/* <div className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl" aria-hidden="true">
        <div
          // the changed color in the background
          className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#FFCCCC] to-[#FFC0CB] opacity-30"
          style={{
            clipPath:
            // the outliner of the choice bar
          ...
          <div
           // the effect of premium user
            ...
            className={classNames(
              tier.featured ? 'relative bg-red-100 shadow-2xl' : 'bg-white/60 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
 ...
 */}
            ...
            >
              {tier.features.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <CheckIcon
                    className={classNames(tier.featured ? 'text-green-500' : 'text-green-500', 'h-6 w-5 flex-none')}
                    aria-hidden="true"
                  />
                  <XMarkIcon
            ...
            >
              <button>start </button>
               {/* <ellipse cx={604} cy={512} fill="url(https://ieeexplore.ieee.org/document/9044259)" rx={604} ry={512} /> */}
            </a>
